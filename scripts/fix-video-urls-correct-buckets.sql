-- Update video URLs to use the correct bucket names that actually exist

-- Module A videos - change from "reconnect/ModuleAFRUIT" to "Module A"
...
-- Module B videos - change from "reconnect/Module B" to "Module B"
...
-- Module C videos - change from "reconnect/Module C" to "Module C"
